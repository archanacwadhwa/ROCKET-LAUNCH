...
//  cgproj
//
//  Created by Archana C Wadhwa on 25/06/22.
//
...
for(i=195;i<=200;i++)
{
    ...
    glBegin(GL_LINE_LOOP);//side-panels
...
void page()
{
   ...
   // glBegin(GL_LINE_LOOP);
    ...
    drawstring(100, 379, "NAME : Archana C Wadhwa and Hetvi Nilesh Natvarlal");
    drawstring(100, 360, "USN : 1RN19CS019 AND 1RN19CS056");
